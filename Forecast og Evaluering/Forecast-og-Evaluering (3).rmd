...
fcast_ARIMA_AAPL=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_ARIMA_MSFT=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_ARIMA_AMZN=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_ARIMA_GOOGL=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_ARIMA_BRK.B=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_ARIMA_TSLA=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_ARIMA_NVDA=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_ARIMA_GOOG=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_ARIMA_UNH=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_ARIMA_JPM=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_ARIMA_AVGO=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_ARIMA_V=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_ARIMA_BAC=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_ARIMA_HD=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_ARIMA_MA=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_ARIMA_MRK=ts(fcast, start=c(2020, 1), freq=251)
```
...
h <- 1
n <- length(data_test_ABBV) - h + 1
fcast <- matrix(0, nrow=n, ncol=h)
for(i in 1:n){
 freq=251
 x <- window(data_ABBV, end=c(2019,251) + (i-1)/freq)
 refit <- Arima(x, order=c(6,1,9), include.drift = FALSE, lambda = "auto")
 fcast[i,] <- forecast(refit, h=h)$mean
 }
fcast_ARIMA_ABBV=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_ARIMA_LLY=ts(fcast, start=c(2020, 1), freq=251)
```
...
h <- 1
n <- length(data_test_UPS) - h + 1
fcast <- matrix(0, nrow=n, ncol=h)
for(i in 1:n){
 freq=251
 x <- window(data_UPS, end=c(2019,251) + (i-1)/freq)
 refit <- Arima(x, order=c(7,1,7), include.drift = FALSE, lambda = "auto")
 fcast[i,] <- forecast(refit, h=h)$mean
 }
fcast_ARIMA_UPS=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_ARIMA_CAT=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_ARIMA_SP500=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_RandomWalk_AAPL=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_RandomWalk_MSFT=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_RandomWalk_AMZN=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_RandomWalk_GOOGL=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_RandomWalk_BRK.B=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_RandomWalk_TSLA=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_RandomWalk_NVDA=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_RandomWalk_GOOG=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_RandomWalk_UNH=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_RandomWalk_JPM=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_RandomWalk_AVGO=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_RandomWalk_V=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_RandomWalk_BAC=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_RandomWalk_HD=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_RandomWalk_MA=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_RandomWalk_MRK=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_RandomWalk_ABBV=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_RandomWalk_LLY=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_RandomWalk_UPS=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_RandomWalk_CAT=ts(fcast, start=c(2020, 1), freq=251)
```
...
fcast_RandomWalk_SP500=ts(fcast, start=c(2020, 1), freq=251)
```
...
```{r}
Acc_ARIMA <- data.frame(AAPL= c(MDA(fcast_ARIMA_AAPL, data_test_AAPL), accuracy(fcast_ARIMA_AAPL, data_test_AAPL)),
           MSFT= c(MDA(fcast_ARIMA_MSFT, data_test_MSFT), accuracy(fcast_ARIMA_MSFT, data_test_MSFT)),
           AMZN= c(MDA(fcast_ARIMA_AMZN, data_test_AMZN), accuracy(fcast_ARIMA_AMZN, data_test_AMZN)),
           GOOGL= c(MDA(fcast_ARIMA_GOOGL, data_test_GOOGL), accuracy(fcast_ARIMA_GOOGL, data_test_GOOGL)),
           BRK.B= c(MDA(fcast_ARIMA_BRK.B, data_test_BRK.B), accuracy(fcast_ARIMA_BRK.B, data_test_BRK.B)),
           TSLA= c(MDA(fcast_ARIMA_TSLA, data_test_TSLA), accuracy(fcast_ARIMA_TSLA, data_test_TSLA)),
           NVDA= c(MDA(fcast_ARIMA_NVDA, data_test_NVDA), accuracy(fcast_ARIMA_NVDA, data_test_NVDA)),
           GOOG= c(MDA(fcast_ARIMA_GOOG, data_test_GOOG), accuracy(fcast_ARIMA_GOOG, data_test_GOOG)),
           UNH= c(MDA(fcast_ARIMA_UNH, data_test_UNH), accuracy(fcast_ARIMA_UNH, data_test_UNH)),
           JPM= c(MDA(fcast_ARIMA_JPM, data_test_JPM), accuracy(fcast_ARIMA_JPM, data_test_JPM)),
           AVGO= c(MDA(fcast_ARIMA_AVGO, data_test_AVGO), accuracy(fcast_ARIMA_AVGO, data_test_AVGO)),
           V= c(MDA(fcast_ARIMA_V, data_test_V), accuracy(fcast_ARIMA_V, data_test_V)),
           BAC= c(MDA(fcast_ARIMA_BAC, data_test_BAC), accuracy(fcast_ARIMA_BAC, data_test_BAC)),
           HD= c(MDA(fcast_ARIMA_HD, data_test_HD), accuracy(fcast_ARIMA_HD, data_test_HD)),
           MA= c(MDA(fcast_ARIMA_MA, data_test_MA), accuracy(fcast_ARIMA_MA, data_test_MA)),
           MRK= c(MDA(fcast_ARIMA_MRK, data_test_MRK), accuracy(fcast_ARIMA_MRK, data_test_MRK)),
           ABBV= c(MDA(fcast_ARIMA_ABBV, data_test_ABBV), accuracy(fcast_ARIMA_ABBV, data_test_ABBV)),
           LLY= c(MDA(fcast_ARIMA_LLY, data_test_LLY), accuracy(fcast_ARIMA_LLY, data_test_LLY)),
           UPS= c(MDA(fcast_ARIMA_UPS, data_test_UPS), accuracy(fcast_ARIMA_UPS, data_test_UPS)),
           CAT= c(MDA(fcast_ARIMA_CAT, data_test_CAT), accuracy(fcast_ARIMA_CAT, data_test_CAT)),
           SP500= c(MDA(fcast_ARIMA_SP500, data_test_SP500), accuracy(fcast_ARIMA_SP500, data_test_SP500)),
...
```{r}
write_xlsx(Acc_LSTM, "C:\\Users\\cecil\\OneDrive\\Skrivebord\\Speciale\\lstmeval.xlsx")
```


## Accuracy evaluering Random Walk
```{r}
Acc_RandomWalk <- data.frame(AAPL= c(MDA(fcast_RandomWalk_AAPL, data_test_AAPL), accuracy(fcast_RandomWalk_AAPL, data_test_AAPL)),
           MSFT= c(MDA(fcast_RandomWalk_MSFT, data_test_MSFT), accuracy(fcast_RandomWalk_MSFT, data_test_MSFT)),
           AMZN= c(MDA(fcast_RandomWalk_AMZN, data_test_AMZN), accuracy(fcast_RandomWalk_AMZN, data_test_AMZN)),
           GOOGL= c(MDA(fcast_RandomWalk_GOOGL, data_test_GOOGL), accuracy(fcast_RandomWalk_GOOGL, data_test_GOOGL)),
           BRK.B= c(MDA(fcast_RandomWalk_BRK.B, data_test_BRK.B), accuracy(fcast_RandomWalk_BRK.B, data_test_BRK.B)),
           TSLA= c(MDA(fcast_RandomWalk_TSLA, data_test_TSLA), accuracy(fcast_RandomWalk_TSLA, data_test_TSLA)),
           NVDA= c(MDA(fcast_RandomWalk_NVDA, data_test_NVDA), accuracy(fcast_RandomWalk_NVDA, data_test_NVDA)),
           GOOG= c(MDA(fcast_RandomWalk_GOOG, data_test_GOOG), accuracy(fcast_RandomWalk_GOOG, data_test_GOOG)),
           UNH= c(MDA(fcast_RandomWalk_UNH, data_test_UNH), accuracy(fcast_RandomWalk_UNH, data_test_UNH)),
           JPM= c(MDA(fcast_RandomWalk_JPM, data_test_JPM), accuracy(fcast_RandomWalk_JPM, data_test_JPM)),
           AVGO= c(MDA(fcast_RandomWalk_AVGO, data_test_AVGO), accuracy(fcast_RandomWalk_AVGO, data_test_AVGO)),
           V= c(MDA(fcast_RandomWalk_V, data_test_V), accuracy(fcast_RandomWalk_V, data_test_V)),
           BAC= c(MDA(fcast_RandomWalk_BAC, data_test_BAC), accuracy(fcast_RandomWalk_BAC, data_test_BAC)),
           HD= c(MDA(fcast_RandomWalk_HD, data_test_HD), accuracy(fcast_RandomWalk_HD, data_test_HD)),
           MA= c(MDA(fcast_RandomWalk_MA, data_test_MA), accuracy(fcast_RandomWalk_MA, data_test_MA)),
           MRK= c(MDA(fcast_RandomWalk_MRK, data_test_MRK), accuracy(fcast_RandomWalk_MRK, data_test_MRK)),
           ABBV= c(MDA(fcast_RandomWalk_ABBV, data_test_ABBV), accuracy(fcast_RandomWalk_ABBV, data_test_ABBV)),
           LLY= c(MDA(fcast_RandomWalk_LLY, data_test_LLY), accuracy(fcast_RandomWalk_LLY, data_test_LLY)),
           UPS= c(MDA(fcast_RandomWalk_UPS, data_test_UPS), accuracy(fcast_RandomWalk_UPS, data_test_UPS)),
           CAT= c(MDA(fcast_RandomWalk_CAT, data_test_CAT), accuracy(fcast_RandomWalk_CAT, data_test_CAT)),
           SP500= c(MDA(fcast_RandomWalk_SP500, data_test_SP500), accuracy(fcast_RandomWalk_SP500, data_test_SP500)),
           row.names = c("MDA", "ME", "RMSE", "MAE","MPE", "MAPE","ACF1", "Theil's U"))
```
...
```{r}
DM.test(fcast_LSTM_AAPL, fcast_RandomWalk_AAPL, data_test_AAPL, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_LSTM_AAPL, fcast_RandomWalk_AAPL, data_test_AAPL, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_LSTM_AAPL, fcast_RandomWalk_AAPL, data_test_AAPL, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_LSTM_MSFT, fcast_RandomWalk_MSFT, data_test_MSFT, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_LSTM_MSFT, fcast_RandomWalk_MSFT, data_test_MSFT, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_LSTM_MSFT, fcast_RandomWalk_MSFT, data_test_MSFT, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_LSTM_AMZN, fcast_RandomWalk_AMZN, data_test_AMZN, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_LSTM_AMZN, fcast_RandomWalk_AMZN, data_test_AMZN, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_LSTM_AMZN, fcast_RandomWalk_AMZN, data_test_AMZN, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_LSTM_GOOGL, fcast_RandomWalk_GOOGL, data_test_GOOGL, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_LSTM_GOOGL, fcast_RandomWalk_GOOGL, data_test_GOOGL, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_LSTM_GOOGL, fcast_RandomWalk_GOOGL, data_test_GOOGL, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_LSTM_BRK.B, fcast_RandomWalk_BRK.B, data_test_BRK.B, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_LSTM_BRK.B, fcast_RandomWalk_BRK.B, data_test_BRK.B, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_LSTM_BRK.B, fcast_RandomWalk_BRK.B, data_test_BRK.B, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_LSTM_TSLA, fcast_RandomWalk_TSLA, data_test_TSLA, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_LSTM_TSLA, fcast_RandomWalk_TSLA, data_test_TSLA, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_LSTM_TSLA, fcast_RandomWalk_TSLA, data_test_TSLA, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_LSTM_NVDA, fcast_RandomWalk_NVDA, data_test_NVDA, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_LSTM_NVDA, fcast_RandomWalk_NVDA, data_test_NVDA, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_LSTM_NVDA, fcast_RandomWalk_NVDA, data_test_NVDA, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_LSTM_GOOG, fcast_RandomWalk_GOOG, data_test_GOOG, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_LSTM_GOOG, fcast_RandomWalk_GOOG, data_test_GOOG, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_LSTM_GOOG, fcast_RandomWalk_GOOG, data_test_GOOG, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_LSTM_UNH, fcast_RandomWalk_UNH, data_test_UNH, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_LSTM_UNH, fcast_RandomWalk_UNH, data_test_UNH, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_LSTM_UNH, fcast_RandomWalk_UNH, data_test_UNH, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_LSTM_JPM, fcast_RandomWalk_JPM, data_test_JPM, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_LSTM_JPM, fcast_RandomWalk_JPM, data_test_JPM, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_LSTM_JPM, fcast_RandomWalk_JPM, data_test_JPM, loss.type = "SE", h=1, c=FALSE, H1="more")
DM.test(fcast_LSTM_AVGO, fcast_RandomWalk_AVGO, data_test_AVGO, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_LSTM_AVGO, fcast_RandomWalk_AVGO, data_test_AVGO, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_LSTM_AVGO, fcast_RandomWalk_AVGO, data_test_AVGO, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_LSTM_V, fcast_RandomWalk_V, data_test_V, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_LSTM_V, fcast_RandomWalk_V, data_test_V, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_LSTM_V, fcast_RandomWalk_V, data_test_V, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_LSTM_BAC, fcast_RandomWalk_BAC, data_test_BAC, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_LSTM_BAC, fcast_RandomWalk_BAC, data_test_BAC, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_LSTM_BAC, fcast_RandomWalk_BAC, data_test_BAC, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_LSTM_HD, fcast_RandomWalk_HD, data_test_HD, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_LSTM_HD, fcast_RandomWalk_HD, data_test_HD, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_LSTM_HD, fcast_RandomWalk_HD, data_test_HD, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_LSTM_MA, fcast_RandomWalk_MA, data_test_MA, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_LSTM_MA, fcast_RandomWalk_MA, data_test_MA, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_LSTM_MA, fcast_RandomWalk_MA, data_test_MA, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_LSTM_MRK, fcast_RandomWalk_MRK, data_test_MRK, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_LSTM_MRK, fcast_RandomWalk_MRK, data_test_MRK, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_LSTM_MRK, fcast_RandomWalk_MRK, data_test_MRK, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_LSTM_ABBV, fcast_RandomWalk_ABBV, data_test_ABBV, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_LSTM_ABBV, fcast_RandomWalk_ABBV, data_test_ABBV, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_LSTM_ABBV, fcast_RandomWalk_ABBV, data_test_ABBV, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_LSTM_LLY, fcast_RandomWalk_LLY, data_test_LLY, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_LSTM_LLY, fcast_RandomWalk_LLY, data_test_LLY, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_LSTM_LLY, fcast_RandomWalk_LLY, data_test_LLY, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_LSTM_UPS, fcast_RandomWalk_UPS, data_test_UPS, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_LSTM_UPS, fcast_RandomWalk_UPS, data_test_UPS, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_LSTM_UPS, fcast_RandomWalk_UPS, data_test_UPS, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_LSTM_CAT, fcast_RandomWalk_CAT, data_test_CAT, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_LSTM_CAT, fcast_RandomWalk_CAT, data_test_CAT, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_LSTM_CAT, fcast_RandomWalk_CAT, data_test_CAT, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_LSTM_SP500, fcast_RandomWalk_SP500, data_test_SP500, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_LSTM_SP500, fcast_RandomWalk_SP500, data_test_SP500, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_LSTM_SP500, fcast_RandomWalk_SP500, data_test_SP500, loss.type = "SE", h=1, c=FALSE, H1="more")
```
...
```{r}
DM.test(fcast_ARIMA_AAPL, fcast_LSTM_AAPL, data_test_AAPL, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_ARIMA_AAPL, fcast_LSTM_AAPL, data_test_AAPL, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_ARIMA_AAPL, fcast_LSTM_AAPL, data_test_AAPL, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_ARIMA_MSFT, fcast_LSTM_MSFT, data_test_MSFT, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_ARIMA_MSFT, fcast_LSTM_MSFT, data_test_MSFT, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_ARIMA_MSFT, fcast_LSTM_MSFT, data_test_MSFT, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_ARIMA_AMZN, fcast_LSTM_AMZN, data_test_AMZN, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_ARIMA_AMZN, fcast_LSTM_AMZN, data_test_AMZN, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_ARIMA_AMZN, fcast_LSTM_AMZN, data_test_AMZN, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_ARIMA_GOOGL, fcast_LSTM_GOOGL, data_test_GOOGL, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_ARIMA_GOOGL, fcast_LSTM_GOOGL, data_test_GOOGL, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_ARIMA_GOOGL, fcast_LSTM_GOOGL, data_test_GOOGL, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_ARIMA_BRK.B, fcast_LSTM_BRK.B, data_test_BRK.B, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_ARIMA_BRK.B, fcast_LSTM_BRK.B, data_test_BRK.B, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_ARIMA_BRK.B, fcast_LSTM_BRK.B, data_test_BRK.B, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_ARIMA_TSLA, fcast_LSTM_TSLA, data_test_TSLA, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_ARIMA_TSLA, fcast_LSTM_TSLA, data_test_TSLA, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_ARIMA_TSLA, fcast_LSTM_TSLA, data_test_TSLA, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_ARIMA_NVDA, fcast_LSTM_NVDA, data_test_NVDA, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_ARIMA_NVDA, fcast_LSTM_NVDA, data_test_NVDA, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_ARIMA_NVDA, fcast_LSTM_NVDA, data_test_NVDA, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_ARIMA_GOOG, fcast_LSTM_GOOG, data_test_GOOG, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_ARIMA_GOOG, fcast_LSTM_GOOG, data_test_GOOG, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_ARIMA_GOOG, fcast_LSTM_GOOG, data_test_GOOG, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_ARIMA_UNH, fcast_LSTM_UNH, data_test_UNH, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_ARIMA_UNH, fcast_LSTM_UNH, data_test_UNH, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_ARIMA_UNH, fcast_LSTM_UNH, data_test_UNH, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_ARIMA_JPM, fcast_LSTM_JPM, data_test_JPM, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_ARIMA_JPM, fcast_LSTM_JPM, data_test_JPM, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_ARIMA_JPM, fcast_LSTM_JPM, data_test_JPM, loss.type = "SE", h=1, c=FALSE, H1="more")
DM.test(fcast_ARIMA_AVGO, fcast_LSTM_AVGO, data_test_AVGO, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_ARIMA_AVGO, fcast_LSTM_AVGO, data_test_AVGO, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_ARIMA_AVGO, fcast_LSTM_AVGO, data_test_AVGO, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_ARIMA_V, fcast_LSTM_V, data_test_V, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_ARIMA_V, fcast_LSTM_V, data_test_V, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_ARIMA_V, fcast_LSTM_V, data_test_V, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_ARIMA_BAC, fcast_LSTM_BAC, data_test_BAC, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_ARIMA_BAC, fcast_LSTM_BAC, data_test_BAC, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_ARIMA_BAC, fcast_LSTM_BAC, data_test_BAC, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_ARIMA_HD, fcast_LSTM_HD, data_test_HD, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_ARIMA_HD, fcast_LSTM_HD, data_test_HD, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_ARIMA_HD, fcast_LSTM_HD, data_test_HD, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_ARIMA_MA, fcast_LSTM_MA, data_test_MA, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_ARIMA_MA, fcast_LSTM_MA, data_test_MA, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_ARIMA_MA, fcast_LSTM_MA, data_test_MA, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_ARIMA_MRK, fcast_LSTM_MRK, data_test_MRK, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_ARIMA_MRK, fcast_LSTM_MRK, data_test_MRK, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_ARIMA_MRK, fcast_LSTM_MRK, data_test_MRK, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_ARIMA_ABBV, fcast_LSTM_ABBV, data_test_ABBV, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_ARIMA_ABBV, fcast_LSTM_ABBV, data_test_ABBV, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_ARIMA_ABBV, fcast_LSTM_ABBV, data_test_ABBV, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_ARIMA_LLY, fcast_LSTM_LLY, data_test_LLY, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_ARIMA_LLY, fcast_LSTM_LLY, data_test_LLY, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_ARIMA_LLY, fcast_LSTM_LLY, data_test_LLY, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_ARIMA_UPS, fcast_LSTM_UPS, data_test_UPS, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_ARIMA_UPS, fcast_LSTM_UPS, data_test_UPS, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_ARIMA_UPS, fcast_LSTM_UPS, data_test_UPS, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_ARIMA_CAT, fcast_LSTM_CAT, data_test_CAT, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_ARIMA_CAT, fcast_LSTM_CAT, data_test_CAT, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_ARIMA_CAT, fcast_LSTM_CAT, data_test_CAT, loss.type = "SE", h=1, c=FALSE, H1="more")

DM.test(fcast_ARIMA_SP500, fcast_LSTM_SP500, data_test_SP500, loss.type = "SE", h=1, c=FALSE, H1="same")
DM.test(fcast_ARIMA_SP500, fcast_LSTM_SP500, data_test_SP500, loss.type = "SE", h=1, c=FALSE, H1="less")
DM.test(fcast_ARIMA_SP500, fcast_LSTM_SP500, data_test_SP500, loss.type = "SE", h=1, c=FALSE, H1="more")
```
...
```{r}
par(mfrow=c(2,2))
plot(data_test_AAPL, lwd=1, lty=1, main="One-step-ahead forecast - AAPL", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_ARIMA_AAPL, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_MSFT, lwd=1, lty=1, main="1-step-ahead forecast - MSFT", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_ARIMA_MSFT, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_AMZN, lwd=1, lty=1, main="1-step-ahead forecast - AMZN", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_ARIMA_AMZN, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_GOOGL, lwd=1, lty=1, main="1-step-ahead forecast - GOOGL", xlab="Tid", ylab="Aktieafk
ast kr.")
...
```{r}
par(mfrow=c(2,2))
plot(data_test_BRK.B, lwd=1, lty=1, main="One-step-ahead forecast - BRK.B", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_ARIMA_BRK.B, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_TSLA, lwd=1, lty=1, main="1-step-ahead forecast - TSLA", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_ARIMA_TSLA, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_NVDA, lwd=1, lty=1, main="1-step-ahead forecast - NVDA", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_ARIMA_NVDA, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_GOOG, lwd=1, lty=1, main="1-step-ahead forecast - GOOG", xlab="Tid", ylab="Aktieafk
ast kr.")
...
```{r}
par(mfrow=c(2,2))
plot(data_test_UNH, lwd=1, lty=1, main="One-step-ahead forecast - UNH", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_ARIMA_UNH, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_JPM, lwd=1, lty=1, main="1-step-ahead forecast - JPM", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_ARIMA_JPM, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_AVGO, lwd=1, lty=1, main="1-step-ahead forecast - AVGO", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_ARIMA_AVGO, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_V, lwd=1, lty=1, main="1-step-ahead forecast - V", xlab="Tid", ylab="Aktieafk
ast kr.")
...
```{r}
par(mfrow=c(2,2))
plot(data_test_BAC, lwd=1, lty=1, main="One-step-ahead forecast - BAC", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_ARIMA_BAC, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_HD, lwd=1, lty=1, main="1-step-ahead forecast - HD", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_ARIMA_HD, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_MA, lwd=1, lty=1, main="1-step-ahead forecast - MA", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_ARIMA_MA, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_MRK, lwd=1, lty=1, main="1-step-ahead forecast - MRK", xlab="Tid", ylab="Aktieafk
ast kr.")
...
```{r}
par(mfrow=c(2,2))
plot(data_test_ABBV, lwd=1, lty=1, main="One-step-ahead forecast - ABBV", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_ARIMA_ABBV, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_LLY, lwd=1, lty=1, main="1-step-ahead forecast - LLY", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_ARIMA_LLY, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_UPS, lwd=1, lty=1, main="1-step-ahead forecast - UPS", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_ARIMA_UPS, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_CAT, lwd=1, lty=1, main="1-step-ahead forecast - CAT", xlab="Tid", ylab="Aktieafk
ast kr.")
...
plot(data_test_AAPL, lwd=1, lty=1, main="One-step-ahead forecast - AAPL", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_LSTM_AAPL, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_MSFT, lwd=1, lty=1, main="1-step-ahead forecast - MSFT", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_LSTM_MSFT, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_AMZN, lwd=1, lty=1, main="1-step-ahead forecast - AMZN", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_LSTM_AMZN, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_GOOGL, lwd=1, lty=1, main="1-step-ahead forecast - GOOGL", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_LSTM_GOOGL, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))
```
...
plot(data_test_BRK.B, lwd=1, lty=1, main="One-step-ahead forecast - BRK.B", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_LSTM_BRK.B, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_TSLA, lwd=1, lty=1, main="1-step-ahead forecast - TSLA", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_LSTM_TSLA, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_NVDA, lwd=1, lty=1, main="1-step-ahead forecast - NVDA", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_LSTM_NVDA, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_GOOG, lwd=1, lty=1, main="1-step-ahead forecast - GOOG", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_LSTM_GOOG, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))
```
...
plot(data_test_UNH, lwd=1, lty=1, main="One-step-ahead forecast - UNH", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_LSTM_UNH, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_JPM, lwd=1, lty=1, main="1-step-ahead forecast - JPM", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_LSTM_JPM, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_AVGO, lwd=1, lty=1, main="1-step-ahead forecast - AVGO", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_LSTM_AVGO, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_V, lwd=1, lty=1, main="1-step-ahead forecast - V", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_LSTM_V, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))
```
...
plot(data_test_BAC, lwd=1, lty=1, main="One-step-ahead forecast - BAC", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_LSTM_BAC, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_HD, lwd=1, lty=1, main="1-step-ahead forecast - HD", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_LSTM_HD, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_MA, lwd=1, lty=1, main="1-step-ahead forecast - MA", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_LSTM_MA, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_MRK, lwd=1, lty=1, main="1-step-ahead forecast - MRK", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_LSTM_MRK, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))
...
plot(data_test_ABBV, lwd=1, lty=1, main="One-step-ahead forecast - ABBV", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_LSTM_ABBV, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_LLY, lwd=1, lty=1, main="1-step-ahead forecast - LLY", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_LSTM_LLY, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_UPS, lwd=1, lty=1, main="1-step-ahead forecast - UPS", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_LSTM_UPS, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_CAT, lwd=1, lty=1, main="1-step-ahead forecast - CAT", xlab="Tid", ylab="Aktieafk
ast kr.")
lines(fcast_LSTM_CAT, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))
```


### LSTM 6 udvalgte plots

```{r}
par(mfrow=c(2,3))
plot(data_test_AAPL, lwd=1, lty=1, main="One-step-ahead LSTM forecast - APPL IT", xlab="Tid", ylab="Aktiekurs kr.")
lines(fcast_LSTM_AAPL, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_GOOGL, lwd=1, lty=1, main="one-step-ahead LSTM forecast - Alphabet Inc A. Kommunikation", xlab="Tid", ylab="Aktiekurs kr.")
lines(fcast_LSTM_GOOGL, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_UNH, lwd=1, lty=1, main="One-step-ahead LSTM forecast - United Parcel Service Inc. Industri", xlab="Tid", ylab="Aktiekurs kr.")
lines(fcast_LSTM_UNH, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_ABBV, lwd=1, lty=1, main="One-step-ahead LSTM forecast - Abbvie Inc. Sundhed", xlab="Tid", ylab="Aktiekurs kr.")
lines(fcast_LSTM_ABBV, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))


plot(data_test_JPM, lwd=1, lty=1, main="One-step-ahead LSTM forecast - JP Morgan and Chase Finans", xlab="Tid", ylab="Aktiekurs kr.")
lines(fcast_LSTM_JPM, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))


plot(data_test_AMZN, lwd=1, lty=1, main="One-step-ahead LSTM forecast - Amazon.com Inc.", xlab="Tid", ylab="Aktiekurs kr.")
lines(fcast_LSTM_AMZN, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))
...
### ARIMA 6 udvalgte plots

```{r}
par(mfrow=c(2,3))
plot(data_test_AAPL, lwd=1, lty=1, main="One-step-ahead ARIMA forecast - APPL IT", xlab="Tid", ylab="Aktiekurs kr.")
lines(fcast_ARIMA_AAPL, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_GOOGL, lwd=1, lty=1, main="one-step-ahead ARIMA forecast - Alphabet Inc A. Kommunikation", xlab="Tid", ylab="Aktiekurs kr.")
lines(fcast_ARIMA_GOOGL, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_UNH, lwd=1, lty=1, main="One-step-ahead ARIMA forecast - United Parcel Service Inc. Industri", xlab="Tid", ylab="Aktiekurs kr.")
lines(fcast_ARIMA_UNH, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))

plot(data_test_ABBV, lwd=1, lty=1, main="One-step-ahead ARIMA forecast - Abbvie Inc. Sundhed", xlab="Tid", ylab="Aktiekurs kr.")
lines(fcast_ARIMA_ABBV, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))


plot(data_test_JPM, lwd=1, lty=1, main="One-step-ahead ARIMA forecast - JP Morgan and Chase Finans", xlab="Tid", ylab="Aktiekurs kr.")
lines(fcast_ARIMA_JPM, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))


plot(data_test_AMZN, lwd=1, lty=1, main="One-step-ahead ARIMA forecast - Amazon.com Inc.", xlab="Tid", ylab="Aktiekurs kr.")
lines(fcast_ARIMA_AMZN, col="blue")
legend("topleft", c("Data", "Forecast"), bty="n", lty = c(1,1), col=c("black", "blue"))
